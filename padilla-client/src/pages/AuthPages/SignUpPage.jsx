...
const inputClasses =
  'mt-2 w-full min-w-0 box-border rounded-xl border border-zinc-300 bg-zinc-100 px-4 py-3 text-sm text-zinc-900 outline-none transition placeholder:text-zinc-400 focus:border-zinc-900 focus:bg-zinc-50'; 
    ...
    <>
      ...
      <form className="mt-8 space-y-5">
       <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          <div>
            <label htmlFor="first-name" className="text-sm font-medium text-zinc-500">
              First Name
            </label>
            <input
              id="first-name"
          ...
          <div>
            <label htmlFor="last-name" className="text-sm font-medium text-zinc-500">
              Last Name
            </label>
            <input
              id="last-name"
